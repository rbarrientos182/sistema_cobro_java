...
public class IniciarReporteEmpleados
{
     Connection conn = null;
     String conexion = null;

    public IniciarReporteEmpleados ()
    {
        try
        {
    ...
    public void ejecutarReporte(String idmpleados)
    {
          try
          {
              String archivo = System.getProperty("user.dir")+"/Reportes/ReporteEmpleados.jasper";
              ...
              parametro.put("idempleados",idmpleados);
...
} // fin de la clase IniciarReporteEmpleados
